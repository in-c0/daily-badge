// The original pack: one curated "on this day" message for every day of the year
// (366 entries — February 29 included). Keyed by "Month Day".
export default {
  name: "default",
  title: "On this day",
  emoji: "🌟",
  lang: "en",
  description: "A curated fun observance for all 366 days of the year.",
  kind: "calendar",
  messages: {
